...
public class InMemoryWorldDao implements WorldDao {
	...
	@PostConstruct
	public void init() {
		System.err.println("Initializing component...");
	}
	
	@PreDestroy // singleton, when close()
	public void destroy() {
		System.err.println("Destroying component...");
	}
	
	public InMemoryWorldDao() {
		System.err.println("InMemoryWorldDao()");	
		countries = new ConcurrentHashMap<>(); // TS Collection, Multi-core Ready
